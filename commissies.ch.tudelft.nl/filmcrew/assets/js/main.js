...
document.getElementById("save").addEventListener("click", function(event) {
  ...
  if (document.getElementById("save").classList.contains("saveable")) {
    audioRecorder.exportWAV(saveFile);
  }
});
...
function toggleRecording(e) {
  if (e.classList.contains("recording")) {
    ...
    e.innerHTML = '<i class="fas fa-microphone"></i> start recording';
    ...
    e.innerHTML = '<i class="fas fa-microphone-slash"></i> stop recording';
    audioRecorder.clear();
